...
void main() {
    ...
    float sdf;
    if (VAR == 0) {
        vec2 stRect = st + u_offset;
        sdf = sdRoundRect(stRect, vec2(size), roundness);
...
const ShapeBlur = ({
  ...
  }, [variation, pixelRatioProp, shapeSize, roundness, borderSize, circleSize, circleEdge, offsetX, offsetY]);
